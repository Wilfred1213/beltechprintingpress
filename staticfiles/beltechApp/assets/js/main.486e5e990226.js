...
function initCountdown() {
    ...
    countdownElements.forEach(container => {
        ...
        const update = () => {
            ...
            // Update the HTML using the data attributes
            container.querySelector('[data-days]').innerText = days;
            container.querySelector('[data-hours]').innerText = hours;
            container.querySelector('[data-minutes]').innerText = minutes;
            container.querySelector('[data-seconds]').innerText = seconds;
        };
